...
<!-- <link rel="stylesheet" type="text/css" href="catalog/view/theme/German/stylesheet/bootstrap.min.css" /> -->
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="catalog/view/theme/German/stylesheet/test.css" />
<link rel="stylesheet" type="text/css" href="catalog/view/theme/German/stylesheet/main.css" />
<link rel="stylesheet" type="text/css" href="catalog/view/theme/German/stylesheet/lightbox.css" />
      ...
      <div class="collapse navbar-collapse" id="navbar-collapse-home">
        <ul class="nav navbar-nav">
          ...
          <?php if ($categories) { ?>
            ...
            <?php } ?>
          <?php } ?>
          <li><a target="_blank" href="http://camila.capecoralhomeviewer.com/">Haussuche</a></li>
          <li><a href="Testimonials">Was Ihnen gefaellt</a></li>
          <li><a href="Contact-Us">Kopntakt</a></li>
        </ul>
      </div>
    </div>  
  </nav> 
