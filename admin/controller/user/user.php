...
class ControllerUserUser extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('user/user/update', 'token=' . $this->session->data['token'] . '&user_id=' . $result['user_id'] , 'SSL'),
				'class' => 'btn-edit'
			);

			$admin_group = array();
			$admin_group = $this->model_user_user_group->getUserGroup($result['user_group_id']);
		...
		$this->data['admins'] = $this->language->get('admins');
	...
	protected function getForm() {
		$this->data['heading_title'] = $this->language->get('heading_title');
		$this->data['heading'] = $this->language->get('heading');
		$this->data['admin_form_title'] = $this->language->get('admin_form_title');
		$this->data['admin_new'] = $this->language->get('admin_new');
		...
		$this->data['breadcrumbs'][] = array(
			'text'      => $this->language->get('admin_new'),
			'class'      => 'active'
		);
