              ...
              <div class="row">    
                <div class="col-sm-12 text-right"> 
                  <div class="controls control-btns">
                    <a style="display:none;" onclick="$('form').attr('action', '<?php echo $approve; ?>'); $('form').submit();" class="btn btn-success"><?php echo $button_approve; ?></a>
            ...
            <div class="tile-body">
              ...
              <div class="table-responsive">
                <form action="" method="post" enctype="multipart/form-data" id="form">      
                  <table class="table table-datatable table-custom table-striped" id="clientDataTable">
                    <thead>
                      <tr>
                        <th style="width: 40px;">
                        ...
                        <th class="sort-alpha"><?php echo $column_email; ?></th>
                        <th class="sort-numeric text-center"><?php echo $column_phone; ?></th>
                        ...
                        <?php if ($members) { ?>
                          ...
                          <?php foreach ($members as $member) { ?>
                            <tr>
                              <td>
                                <div class="checkbox check-transparent">
                                  <?php if ($member['selected']) { ?>
                                    <input type="checkbox" name="selected[]" value="<?php echo $member['member_id']; ?>" id="<?php echo 'chck'.$chck; ?>" checked="checked">
                                  <?php } else { ?>
                                    <input type="checkbox" name="selected[]" value="<?php echo $member['member_id']; ?>" id="<?php echo 'chck'.$chck; ?>">
                                  <?php } ?>  
                              ...
                              <?php } ?>
                              <td class="text-center"><?php echo $member['date_added']; ?></td>
                              <td>
                                <?php foreach ($member['action'] as $action) { ?>
...
<script>
 $('table thead input[type="checkbox"]').change(function () {
  ...
  $(function(){
      ...
      var oTable01 = $('#clientDataTable').dataTable({
        "sDom":
