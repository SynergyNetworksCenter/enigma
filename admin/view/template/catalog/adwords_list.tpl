...
<?php echo $navigation; ?>
  <div id="content" class="col-md-12">
    <div class="pageheader">
      <h2><i class="fa fa-bar-chart" style="line-height: 48px;"></i> <?php echo $page_title; ?></h2>
        ...
        <div class="col-md-12">   
          ...
          <section class="tile color transparent-black btop-green">
            ...
            <div class="tile-header">
              <h1><i class="fa fa-google"></i> <?php echo $section_title; ?></h1>
              <div class="controls">
            ...
            <div class="tile-body">
              ...
              <div class="table-responsive"> 
                <form action="" method="post" enctype="multipart/form-data" id="form">   
                  <table class="table table-datatable table-custom table-striped" id="adwordsDataTable">
                    <thead>
                      <tr>
                        <th style="width: 40px;">
                        ...
                        <th class="sort-alpha"><?php echo $column_adwords_id; ?></th>
                    ...
                    <tbody>
                      <?php if ($adwords) { ?>
                        <?php $chck = 01; ?>
                        <?php foreach ($adwords as $account) { ?>
                          <tr>
                            <td>
                              <div class="checkbox check-transparent">
                                <?php if ($account['selected']) { ?>
                                  <input type="checkbox" name="selected[]" value="<?php echo $account['id']; ?>" id="<?php echo 'chck'.$chck; ?>" checked="checked">
                                <?php } else { ?>
                                  <input type="checkbox" name="selected[]" value="<?php echo $account['id']; ?>" id="<?php echo 'chck'.$chck; ?>">
                                <?php } ?>  
                                <label for="<?php echo 'chck'.$chck; ?>"></label>
                              </div>
                            </td>
                            <td><?php echo $account['adwords_id']; ?></td>
                            <td><?php echo $account['website']; ?></td>
                            <td><?php echo $account['title']; ?></td>
                            
                            <?php if ($account['status'] == 'Disabled') { ?>
                              <td class="color-red priority text-center">
                                <?php echo $account['status']; ?>
                              </td>  
                            <?php } else { ?>
                              <td class="color-green priority">
                                <?php echo $account['status']; ?>
                              </td>  
                            <?php } ?>
                            <td class="text-center"><?php echo $account['date_added']; ?></td>
                            <td>
...
<script type="text/javascript">
  <!-- 
  function filter() {
      url = 'index.php?route=catalog/adwords&token=<?php echo $token; ?>';
...
<script>
  $(function(){
      ...
      var oTable01 = $('#adwordsDataTable').dataTable({
        "sDom":
