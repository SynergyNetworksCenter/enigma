            ...
            <div class="tile-body">
              ...
              <div class="table-responsive"> 
                <form action="" method="post" enctype="multipart/form-data" id="form">   
                  <table class="table table-datatable table-custom table-striped" id="analyticsDataTable">
                    <thead>
                      <tr>
                        <th style="width: 40px;">
                        ...
                        <th class="sort-alpha"><?php echo $column_analytics_id; ?></th>
                    ...
                    <tbody>
                      <?php if ($analytics) { ?>
                        <?php $chck = 01; ?>
                        <?php foreach ($analytics as $account) { ?>
                          <tr>
                            <td>
                              <div class="checkbox check-transparent">
                            ...
                            <td><?php echo $account['analytics_id']; ?></td>
...
<script>
  ...
  $(function(){
      ...
      var oTable01 = $('#analyticsDataTable').dataTable({
        "sDom":
