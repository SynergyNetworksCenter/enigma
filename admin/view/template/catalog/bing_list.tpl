        ...
        <div class="col-md-12">   
          ...
          <section class="tile color transparent-black btop-green">
            ...
            <div class="tile-header">
              <h1><i class="fa fa-windows"></i> <?php echo $section_title; ?></h1>
              <div class="controls">
            ...
            <div class="tile-body">
              ...
              <div class="table-responsive"> 
                <form action="" method="post" enctype="multipart/form-data" id="form">   
                  <table class="table table-datatable table-custom table-striped" id="bingDataTable">
                    <thead>
                      <tr>
                        <th style="width: 40px;">
                        ...
                        <th class="sort-alpha"><?php echo $column_bing_id; ?></th>
                      ...
                      <?php if ($bing) { ?>
                        ...
                        <?php foreach ($bing as $account) { ?>
                          <tr>
                            ...
                            <td><?php echo $account['bing_id']; ?></td>
...
<script>
  ...
  $(function(){
      ...
      var oTable01 = $('#bingDataTable').dataTable({
        "sDom":
