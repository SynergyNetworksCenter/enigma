        ...
        <div class="tab-pane" id="tab-attribute">
          <table id="attribute" class="tile table table-bordered table-striped transbg">
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                <td class="left">
                  <input type="text" name="post_attribute[<?php echo $attribute_row; ?>][name]" value="<?php echo $post_attribute['name']; ?>" />
                  <input type="hidden" name="post_attribute[<?php echo $attribute_row; ?>][attribute_id]" value="<?php echo $post_attribute['attribute_id']; ?>" />
                </td>
                <td class="left">  
                    <input type="text" name="post_attribute[<?php echo $attribute_row; ?>][post_attribute_description][1][text]" value="<?php echo isset($post_attribute['post_attribute_description'][1]) ? $post_attribute['post_attribute_description'][1]['text'] : ''; ?>" />
                </td>
                <td class="left">
                  <a onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();" class="btn btn-danger"><?php echo $button_remove; ?></a>
                </td>
              </tr>
            </tbody>
            <?php $attribute_row++; ?>
...
function addAttribute() {
	...
	html += '<input type="text" name="post_attribute[' + attribute_row + '][post_attribute_description][1][text]" value=""/>';
	html += '    </td>';
