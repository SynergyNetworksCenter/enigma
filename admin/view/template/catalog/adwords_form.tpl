              ...
              <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label">
                    <span class="required color-red">*</span> <?php echo $entry_adwords_id; ?>
                  </label>
                  <div class="col-md-6">
                    <input class="form-control" type="text" name="adwords_id" value="<?php echo $adwords_id; ?>" />
                    <?php if ($error_adwords_id) { ?>
                      <span class="error color-red"><?php echo $error_adwords_id; ?></span>
                    <?php } ?>
                  </div>
                </div>
