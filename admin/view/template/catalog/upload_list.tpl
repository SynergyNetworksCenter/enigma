            ...
            <div class="tile-body">
              ...
              <div class="table-responsive">
                <form action="" method="post" enctype="multipart/form-data" id="form">
                  <table class="table table-datatable table-custom table-striped" id="uploadDataTable">
                    <thead>
                      <tr>
                        <th style="width: 40px;">
                      ...
                      <?php if ($upload) { ?>
                        ...
                        <?php foreach ($upload as $account) { ?>
                          <tr>
                            ...
                            <td><?php echo $account['upload_id']; ?></td>
...
<script>
  ...
  $(function(){
      ...
      var oTable01 = $('#uploadDataTable').dataTable({
        "sDom":
