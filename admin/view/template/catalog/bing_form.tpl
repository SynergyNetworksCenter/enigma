              ...
              <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label">
                    <span class="required color-red">*</span> <?php echo $entry_bing_id; ?>
                  </label>
                  <div class="col-md-6">
                    <input class="form-control" type="text" name="bing_id" value="<?php echo $bing_id; ?>" />
                    <?php if ($error_bing_id) { ?>
                      <span class="error color-red"><?php echo $error_bing_id; ?></span>
                    <?php } ?>
                  </div>
                </div>
