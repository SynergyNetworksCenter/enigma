  ...
  <div class="box">
    <div class="heading">
      ...
      <div id="buttonGroup" class="pull-right">
        ...
        <a onclick="$('form').attr('action', '<?php echo $enable; ?>'); $('form').submit();" class="btn transbg enable"><?php echo $button_enable; ?></a>
        <a onclick="$('form').attr('action', '<?php echo $disable; ?>'); $('form').submit();" class="btn transbg disable"><?php echo $button_disable; ?></a>
        ...
        <table class="tile table table-bordered table-striped transbg">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><?php echo $post['site']; ?></td>
