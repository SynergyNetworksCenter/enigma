                ...
                <div class="row">
                  <div class="col-sm-12 text-right"> 
                    <div class="controls control-btns">
                      <a href="<?php echo $insert; ?>" class="btn btn-insert"><?php echo $button_insert; ?></a> <!-- inset new admin -->
              ...
              <div class="tile-body">
                <div class="table-responsive"> 
                  <form action="" method="post" enctype="multipart/form-data" id="form">   
                    <table class="table table-datatable table-custom table-striped" id="adminGroupDataTable">
                      <thead>
                        <tr>
                          <th style="width: 40px;">
                          ...
                          <th class=""><?php echo $column_action; ?></th>             
                        </tr>
                      </thead>
                      <tbody> 
                        <?php if ($user_groups) { ?>
                              ...
                              <td>
                                <div class="checkbox check-transparent">
                                  <?php if ($user_group['selected']) { ?>
                                    <input type="checkbox" name="selected[]" value="<?php echo $user_group['user_group_id']; ?>" id="<?php echo 'chck'.$chck; ?>" checked="checked">
                                  <?php } else { ?>
                                    <input type="checkbox" name="selected[]" value="<?php echo $user_group['user_group_id']; ?>" id="<?php echo 'chck'.$chck; ?>">
                                  <?php } ?>  
...
<script>
    ...
    $(function(){
      ...
      var oTable01 = $('#adminGroupDataTable').dataTable({
        "sDom":
